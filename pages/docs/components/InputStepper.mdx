...
<DemoBox
  ...
  code={[
    ...
    '<InputStepper size="medium" />',
    '<InputStepper size="large" />'
  ].join("\n")}
>
  <InputStepper size="small" className="demoSubject" />
  <InputStepper size="medium" className="demoSubject" />
  <InputStepper size="large" className="demoSubject" />
</DemoBox>
