...
export const meta = {
  title: "RadioGroup",
  description: "RadioGroups are used to group and manage radio controls.",
...
<table cols={4}>
  <caption>RadioGroup Properties</caption>
  <thead>
    <tr>
      <th>Name</th>
      <th>Type</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>string</td>
      <td>-</td>
      <td>The name of the radio controls.</td>
    </tr>
    <tr>
      <td>value</td>
      <td>string</td>
      <td>-</td>
      <td>The value of the selected radio.</td>
    </tr>
    <tr>
      <td>defaultValue</td>
      <td>string</td>
    ...
    <tr>
      ...
      <td>-</td>
      <td>
        The Callback fires when a radio has selected.
        <br />
        <em>
