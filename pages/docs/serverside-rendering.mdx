...
<Head>
  ...
  {setCanonicalMeta(`https://sonnat.dev/docs/serverside-rendering`)}
  {setKeywordsMeta([
...
<div data-notebox style={{ marginTop: 0 }}>
  ...
  in CSS.
  <br />
  2- Adds <strong>dir</strong> attribute (based on the provided theme) to the <strong>
    body
  </strong> element.
  <br />
  ...
  <br />
  To learn more about the <strong>&lt;CssBaseline&gt;</strong> component, read <a href="/docs/components/CssBaseline">
    this
  </a>.
</div>
...
<p>
  ...
  <inlineCode>ReactDOMServer.renderToString()</inlineCode>. We then get the CSS from
  the sheets using <inlineCode>sheets.toString()</inlineCode>.<br />
  The final step on the server-side is to inject the initial component HTML and
  CSS into a template to be rendered on the client side.
</p>
...
<p>
  ...
  under the{" "}
  <a
    href="https://github.com/sonnat/sonnat-ui/tree/main/examples/nextjs"
    rel="noopener noreferrer"
    target="_blank"
  >
    /examples
